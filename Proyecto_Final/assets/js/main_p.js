document.querySelector('#btnAddPas').addEventListener('click', savePas);
tablePas();
...
function savePas(){
    ...
    addPas(snum,sname,sapellido,ssapellido,scal1,scal2,scal3,scal4);
    tablePas();
}
...
function tablePas() {
    var list = getPasList(),
        tbody = document.querySelector('#PasTable tbody');
